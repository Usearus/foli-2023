...
const JobsPage = () => {
  ...
  useEffect(() => {
    // RUNS INITIAL ONBOARDING FOR USERS
    if (userProfile) {
      const onboarded = !!userProfile.fields['onboarded'];
      if (typeof onboarded === 'undefined') {
        userProfile.fields['onboarded'] = false;
      }
      setIsOnboarded(onboarded);
      setShowModal(!onboarded);
      // console.log('onboarded', onboarded);
    }
  }, [userProfile]);

  const handleSubmit = () => {
    // START RUNNING AIRTABLE CHANGES
    handleAddPref();
    setShowModal(false);
    setIsOnboarded(true);
  };
      ...
      <>
        ...
        >
          ...
          <Modal.Body>
            ...
            <p>
              Your response helps tailor your experience. This can be updated in
              your preferences anytime.
            </p>
            <Form>
              <Form.Group className='mb-4' controlId='position'>
                <Form.Label>What position are you looking for?</Form.Label>
                <Form.Control
                  type='text'
