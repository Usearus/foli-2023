...
const SideBarAssistant = () => {
    ...
    const [selectedExistingPageContent, setSelectedExistingPageContent] = useState('');
    ...
    const handleNewPageSelect = (event) => {
        ...
        if (event.target.value === 'Interview questions you may be asked') {
            setPromptNewPage('craft 10 interview questions that I may be asked by the interviewer');
        }
        if (event.target.value === 'Interview questions you can ask') {
            setPromptNewPage('craft 10 interview questions that I should say in the interview');
        }
    };
                ...
                <Wrapper>
                        ...
                        <Form id='assistantForm'>
                            ...
                            <Form.Group className='mb-3' controlId='assistant'>
                                ...
                                <Form.Select value={selectedNewPage} onChange={handleNewPageSelect} aria-label="Default select example">
                                    <option value="">Choose an option</option>
                                    <option value="Resume">Resume</option>
                                    <option value="Cover letter">Cover letter</option>
                                    <option value="Interview questions you may be asked">Interview questions you may be asked</option>
                                    <option value="Interview questions you can ask">Interview questions you can ask</option>
                                </Form.Select>
                            </Form.Group>           
                            {/* Content */}
                            <Form.Group className='mb-3' controlId='content'>
                            <Form.Label>From existing page *</Form.Label>
                                <Form.Select aria-label="Default select example" onChange={handleExistingPageSelect}>
                            ...
                            {!generatedAttempt ? (
                                ...
                                <>
                                    <Button variant="outline-secondary" onClick={handleGenerateClick}>
